...
async function ConflictoTable({ conflicto, busqueda }) {
    // Aplica la lógica de búsqueda aquí
    const esMatch = (str) => str.toLowerCase().includes(busqueda.toLowerCase());

    // Si hay una búsqueda y el conflicto no coincide, devuelve null para omitirlo
    if (busqueda && !esMatch(conflicto.evento)) {
        return null;
    }
